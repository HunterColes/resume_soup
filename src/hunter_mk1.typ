...
#cventry(
  tl: [
    *Personal Projects* #githublink(text: "HunterColes", "https://github.com/HunterColes")
  ],
  tr: dates(from: "2023")
)[
  - *Stock Tracking Application*: Developed a privacy-focused stock tracking app using Yahoo Finance API as a tracker-free alternative to commercial finance apps. Built with focus on user privacy and clean interface design.
  - *Poker Payout Calculator*: Created a sleek GUI application for calculating poker tournament payouts with customizable weights, food pool, and bounty pool features. Features modern poker-themed design with dark green color scheme.
  - *Brain Tumor Analysis*: Implemented ML segmentation pipeline for detecting brain tumors and calculating necrotic tissue percentages using the BraTS2020 dataset. Coursework project demonstrating medical imaging expertise.
]
